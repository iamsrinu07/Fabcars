            ...
            <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12 justify-between text-white gap-10">
                ...
                <div className="max-w-[550px] space-y-5 text-center lg:text-left">
                    <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
                        ...
                        a Bespoke Chauffeur Quote in Minutes
                    </h2>
                    ...
                    <ul className="flex flex-wrap gap-x-6 gap-y-2 text-white">
                        <li className="flex items-center before:content-['•'] before:mr-2 before:text-white">
                            Fast response
                        </li>
                        <li className="flex items-center before:content-['•'] before:mr-2 before:text-white">
